  ...
  if (mode == "help"){
    ...
    if (input_type == "video" || input_type == "webcam"){
      ...
      while (1){
        ...
        //f.klt_track_face(name, label, face_pos, frame, prev_frame, features);
